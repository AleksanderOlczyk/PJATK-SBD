--DROP
DROP TABLE IF EXISTS ProjektyZespolu;
DROP TABLE IF EXISTS CzlonkowieZespolu;
...
SELECT Nazwa, TRUNC(SYSDATE - Data_rozpoczecia) AS Dni_Realizacji
FROM Projekt
...
FROM Osoba O
JOIN Pracownik P ON O.Id_osoby = P.Osoba_Id_osoby
WHERE P.Data_zatrudnienia > TO_DATE('2022-01-01', 'YYYY-MM-DD');
